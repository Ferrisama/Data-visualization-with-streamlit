...
DATA_URL = (
    r"C:\Users\asmit\Desktop\DV\streamlit\Motor_Vehicle_Collisions_-_Crashes.csv"
)

st.title("Motor Vehicle Collisions in NYC")
st.markdown("This application is a streamlit dashboard that can be used"
            "to analyse motor vehicle collisons in NYC 🗽💥🚗")
...
injured_people = st.slider("Number of persons in vehicle collisions", 0, 19)
